...
public class FieldParser extends Parser {
    ...
    public static class FieldContext extends ParserRuleContext {
        ...
        public List<TerminalNode> NL() {
            return getTokens(FieldParser.NL);
        }
        ...
        public TerminalNode EOF() {
            return getToken(FieldParser.EOF, 0);
        }

        public TerminalNode Name() {
            return getToken(FieldParser.Name, 0);
        }
    ...
    public static class PointsContext extends ParserRuleContext {
        ...
        public List<TerminalNode> WS() {
            return getTokens(FieldParser.WS);
        }
    ...
    public static class LocationContext extends ParserRuleContext {
        ...
        public List<TerminalNode> Int() {
            return getTokens(FieldParser.Int);
        }
