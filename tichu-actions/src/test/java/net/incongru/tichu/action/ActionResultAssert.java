...
public class ActionResultAssert extends AbstractAssert<ActionResultAssert, ActionResponse> {
    ...
    public ActionResultAssert isSuccessPlayResult(PlayerPlaysResult expectedResultType) {
        isNotNull();
        // not producing great stack trace (starts in the assert methods) or errors (bc PlayResult
        // doesnt have a toString)
    ...
    public ActionResultAssert isErrorPlayResult(
            PlayerPlaysResult expectedResultType, Predicate<String> errorMessagePredicate) {
        isNotNull();
        return isInstanceOf(PlayerPlaysResponse.class)
    ...
    private <ARR extends ActionResponse.Result> Consumer<ActionResponse> hasResultType(
            ARR expectedResultType) {
