...
public class CardComparators {
    ...
    private static final Comparator<CardValue> V_PLAY_ORDER =
            comparingInt(CardValue::playOrder).thenComparing(CardValue::shortName);
    private static final Comparator<Card> PLAY_ORDER = comparing(Card::val, V_PLAY_ORDER);
    private static final Comparator<Card> SUIT =
            comparing(Card::suit, nullsFirst(comparing(CardSuit::shortName)));
