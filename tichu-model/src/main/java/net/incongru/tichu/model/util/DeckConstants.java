...
public class DeckConstants {
    ...
    // ==== Start CodeGen -- this was generated by class
    // net.incongru.tichu.model.util.DeckConstantsCodeGen on 2024-12-05T05:04:12.015832Z
    // prettier-ignore
            ...
            for (final Field field : fields) {
                ...
                if (Modifier.isStatic(mod) && Modifier.isPublic(mod) && Modifier.isFinal(mod)) {
                    if (Card.class.equals(field.getType())) {
                        ...
                        // we know constants starting with _ are special cards and their shortName()
                        // impls start with a *
