...
public class DeckConstants {
    ...
    public static final Card Pagoda_2 = Card.of(
        CardNumbers.Two,
        CardSuit.Pagoda
    );
    public static final Card B2 = Pagoda_2;
    public static final Card Pagoda_3 = Card.of(
        CardNumbers.Three,
        CardSuit.Pagoda
    );
    public static final Card B3 = Pagoda_3;
    public static final Card Pagoda_4 = Card.of(
        CardNumbers.Four,
        CardSuit.Pagoda
    );
    public static final Card B4 = Pagoda_4;
    public static final Card Pagoda_5 = Card.of(
        CardNumbers.Five,
        CardSuit.Pagoda
    );
    public static final Card B5 = Pagoda_5;
    public static final Card Pagoda_6 = Card.of(
        CardNumbers.Six,
        CardSuit.Pagoda
    );
    public static final Card B6 = Pagoda_6;
    public static final Card Pagoda_7 = Card.of(
        CardNumbers.Seven,
        CardSuit.Pagoda
    );
    public static final Card B7 = Pagoda_7;
    public static final Card Pagoda_8 = Card.of(
        CardNumbers.Eight,
        CardSuit.Pagoda
    );
    public static final Card B8 = Pagoda_8;
    public static final Card Pagoda_9 = Card.of(
        CardNumbers.Nine,
        CardSuit.Pagoda
    );
    public static final Card B9 = Pagoda_9;
    public static final Card Pagoda_10 = Card.of(
        CardNumbers.Ten,
        CardSuit.Pagoda
    );
    public static final Card B0 = Pagoda_10;
    public static final Card B10 = Pagoda_10;
    public static final Card Pagoda_Jack = Card.of(
        CardNumbers.Jack,
        CardSuit.Pagoda
    );
    public static final Card BJ = Pagoda_Jack;
    public static final Card Pagoda_Queen = Card.of(
        CardNumbers.Queen,
        CardSuit.Pagoda
    );
    public static final Card BQ = Pagoda_Queen;
    public static final Card Pagoda_King = Card.of(
        CardNumbers.King,
        CardSuit.Pagoda
    );
    public static final Card BK = Pagoda_King;
    public static final Card Pagoda_Ace = Card.of(
        CardNumbers.Ace,
        CardSuit.Pagoda
    );
    ...
    public static final Card Jade_Jack = Card.of(
        CardNumbers.Jack,
        CardSuit.Jade
    );
    public static final Card GJ = Jade_Jack;
    public static final Card Jade_Queen = Card.of(
        CardNumbers.Queen,
        CardSuit.Jade
    );
    public static final Card GQ = Jade_Queen;
    public static final Card Jade_King = Card.of(
        CardNumbers.King,
        CardSuit.Jade
    );
    ...
    public static final Card Sword_3 = Card.of(
        CardNumbers.Three,
        CardSuit.Sword
    );
    public static final Card K3 = Sword_3;
    public static final Card Sword_4 = Card.of(
        CardNumbers.Four,
        CardSuit.Sword
    );
    public static final Card K4 = Sword_4;
    public static final Card Sword_5 = Card.of(
        CardNumbers.Five,
        CardSuit.Sword
    );
    ...
    public static final Card Sword_7 = Card.of(
        CardNumbers.Seven,
        CardSuit.Sword
    );
    public static final Card K7 = Sword_7;
    public static final Card Sword_8 = Card.of(
        CardNumbers.Eight,
        CardSuit.Sword
    );
    public static final Card K8 = Sword_8;
    public static final Card Sword_9 = Card.of(
        CardNumbers.Nine,
        CardSuit.Sword
    );
    public static final Card K9 = Sword_9;
    public static final Card Sword_10 = Card.of(
        CardNumbers.Ten,
        CardSuit.Sword
    );
    public static final Card K0 = Sword_10;
    public static final Card K10 = Sword_10;
    public static final Card Sword_Jack = Card.of(
        CardNumbers.Jack,
        CardSuit.Sword
    );
    public static final Card KJ = Sword_Jack;
    public static final Card Sword_Queen = Card.of(
        CardNumbers.Queen,
        CardSuit.Sword
    );
    public static final Card KQ = Sword_Queen;
    public static final Card Sword_King = Card.of(
        CardNumbers.King,
        CardSuit.Sword
    );
    public static final Card KK = Sword_King;
    public static final Card Sword_Ace = Card.of(
        CardNumbers.Ace,
        CardSuit.Sword
    );
    ...
    public static final Card Star_Jack = Card.of(
        CardNumbers.Jack,
        CardSuit.Star
    );
    public static final Card RJ = Star_Jack;
    public static final Card Star_Queen = Card.of(
        CardNumbers.Queen,
        CardSuit.Star
    );
    public static final Card RQ = Star_Queen;
    public static final Card Star_King = Card.of(
        CardNumbers.King,
        CardSuit.Star
    );
