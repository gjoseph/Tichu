...
class AbstractPlayTest {
    ...
    void correctlyFindLowestCard() {
        final Set<Card> cards =
                Set.of(
                        Pagoda_9, Pagoda_7, Sword_4, Pagoda_5, Pagoda_6, Pagoda_4, Pagoda_8,
                        Pagoda_10);
        final FakePlay play = new FakePlay(cards);
        final Card smallestCard = play.smallestCard();
        assertThat(smallestCard)
                .isIn(Pagoda_4, Sword_4); // we don't really care which of these 2 it is

        // Just checking my assumptions about matchers below:
        assertThat(cards)
                .contains(
                        Pagoda_4, Pagoda_5, Pagoda_6, Pagoda_7, Pagoda_8, Pagoda_9, Pagoda_10,
                        Sword_4);
    }
