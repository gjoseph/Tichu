...
class DeckConstantsTest {
    ...
    void cardNamesAreCaseInsensitive() {
        assertThat(DeckConstants.byName("B2")).isEqualTo(
            DeckConstants.Pagoda_2
        );
        assertThat(DeckConstants.byName("b2")).isEqualTo(
            DeckConstants.Pagoda_2
        );
        assertThat(DeckConstants.byName("paGODA_2")).isEqualTo(
            DeckConstants.Pagoda_2
        );
        assertThat(DeckConstants.byName("mahjonG")).isEqualTo(
            DeckConstants.MahJong
        );
    ...
    void specialCards() {
        ...
        assertThat(DeckConstants.byName("_D")).isEqualTo(DeckConstants.Dragon);
        assertThat(DeckConstants.byName("Dragon")).isEqualTo(
        ...
        assertThat(DeckConstants.byName("Phoenix")).isEqualTo(
            DeckConstants.Phoenix
        );
