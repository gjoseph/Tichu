...
export const cardFromName = (shortName: string): Card => {
    return AllCards.find((c) => c.shortName === shortName) as Card;
};

// ==== Start CodeGen -- this was generated by class net.incongru.tichu.model.util.DeckConstantsCodeGen on 2020-04-25T04:02:19.334458Z
