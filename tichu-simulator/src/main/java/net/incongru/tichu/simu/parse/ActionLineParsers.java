            ...
            Arrays.asList(
                ...
                simpleParser(
                    ...
                    t -> {
                        ...
                        return JoinTableParam.withActor(
                            UserId.of(playerName),
                            team
                        );
                    }
                ),
                simpleParser(
                    ...
                    t -> {
                        final String playerName = t.pop(0);
                        return PlayerIsReadyParam.withActor(
                            UserId.of(playerName)
                        );
                    }
                ),
                simpleParser(
                    ...
                    t -> {
                        ...
                        return CheatDealParam.withActor(
                            UserId.of(playerName),
                            cards
                        );
                    }
                    ...
                    t -> {
                        ...
                        if (t.count() < 1) {
                            throw new LineParserException(
                                t,
                                "No cards played, use the '<player> passes' action instead."
                            );
                        }
                        final Set<Card> cards = t.remainderAsCards();
